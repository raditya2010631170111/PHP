...
<body>
    ...
    <section class="footer mt-5 text-white" style="background-color:#001d3d">
        <div class="container">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2">
                            <a href="{{ route('admin.index_game') }}" class="nav-link1 p-0 text-white"
                                style="text-decoration: none">Movie</a>
                        </li>
                        <li class="nav-item mb-2">
                            <a href="/about" class="nav-link1 p-0 text-white" style="text-decoration: none">About</a>
                        </li>
                        <li class="nav-item mb-2">
                            <a href="/contactus" class="nav-link1 p-0 text-white" style="text-decoration: none">Contact
                                Us</a>
                        </li>
                    </ul>
                </div>
